...
public class GpuFrequencyFragment extends Fragment {
    ...
    private GpuFrequencyViewModel gpuFrequencyViewModel;

    @Override
    public void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        // Initialize ViewModels - get from parent activity for shared state
        MainActivity activity = (MainActivity) getActivity();
        if (activity != null) {
            deviceViewModel = activity.getDeviceViewModel();
            gpuFrequencyViewModel = new ViewModelProvider(requireActivity()).get(GpuFrequencyViewModel.class);
